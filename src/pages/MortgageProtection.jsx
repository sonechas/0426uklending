      ...
      <div className="form-section-wrapper">
        <div className="form-info-side">
          <h2 className="ultra-heading">
            PROTECT YOUR<br />HOME AND FAMILY.
          </h2>
          <p className="form-desc-large">
            Mortgage protection is more than insurance — it's peace of mind. Ensure your family never has to worry about their home, whatever life throws at them. Our advisors find the right cover, fee-free.
          </p>
        ...
        <div className="form-box-modern">
          ...
          <form onSubmit={handleSubmit} className="modern-form">
            ...
            <div className="form-section">
              <span className="section-label">COVERAGE DETAILS</span>
              <div className="form-grid">
                <div className="form-group-modern">
                  <input className="modern-input" type="number" name="mortgageAmount" placeholder="£ Mortgage Amount" value={formData.mortgageAmount} onChange={handleChange} required />
                  <span className="input-helper">Outstanding Mortgage</span>
                </div>
                <div className="form-group-modern">
                  <input className="modern-input" type="number" name="coverageAmount" placeholder="£ Coverage Amount" value={formData.coverageAmount} onChange={handleChange} required />
                  <span className="input-helper">Desired Cover</span>
                </div>
              </div>
            </div>
